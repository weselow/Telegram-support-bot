...
- [x] Префикс [TG] для Telegram-сообщений при связанных каналах
- [x] Typing indicator → sendChatAction в топик
- [x] Status change → WebSocket уведомление (callback + autoChangeStatus)
- [x] replyTo parameter при отправке сообщений
...
1. **Копирование истории в Telegram** - только синхронизация новых сообщений (отмечено как optional в документации)
2. **Дополнительные тесты** - вынесено в tech debt
