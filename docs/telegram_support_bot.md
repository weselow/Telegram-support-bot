...
|-----------|------------|--------|-------------|
| Язык | TypeScript | 5.x | Типобезопасность, экосистема |
| Runtime | Node.js LTS | 22.x или 24.x | Стабильность, async I/O |
| Telegram SDK | grammY | 1.38.x | Активная поддержка, типизация, conversations |
| База данных | PostgreSQL | 16 | Надёжность, ACID |
| ORM | Prisma | 7.x | Типизированные запросы, миграции, Rust-free |
| Job Queue | BullMQ + Redis | latest | SLA-таймеры, надёжные задачи |
| Логирование | Pino + Sentry | latest | Быстрый JSON + error tracking |

> **Принцип:** всегда использовать актуальные стабильные версии.
